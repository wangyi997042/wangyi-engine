...
export interface BodyScrollOptions {
  ...
  allowTouchMove?: (el: any) => boolean | undefined;
}
...
if (typeof window !== 'undefined') {
  ...
  window.addEventListener('testPassive', null as keyof EventListenerOrEventListenerObject, passiveTestOptions);
  window.removeEventListener('testPassive', null as keyof EventListenerOrEventListenerObject, passiveTestOptions as EventListenerOptions);
}
...
export const clearAllBodyScrollLocks = (): void => {
  if (isIosDevice) {
    ...
    if (documentListenerAdded) {
      document.removeEventListener('touchmove', preventDefault, hasPassiveEvents ? { passive: false } as EventListenerOptions : undefined);
